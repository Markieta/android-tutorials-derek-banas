package com.example.markieta.conversion;
...
public class MainActivity extends AppCompatActivity
{
    ...
    public void updateUnitTypeUsingOther(Quantity.Unit currentUnit) {
        ...
        updateUnitTextFieldUsingTsp(doubleToConvert, currentUnit, Quantity.Unit.pint, poundTextView);
    ...
    public void updateUnitTextFieldUsingTsp(double doubleToConvert, Quantity.Unit currentUnit,
                                            Quantity.Unit prefferedUnit, TextView targetTextView) {
        Quantity currentQuantitySelected = new Quantity(doubleToConvert, currentUnit);
        String tempTextViewText = currentQuantitySelected.to(Quantity.Unit.tsp).to(prefferedUnit).toString();
