...
/**
 * Created by markieta on 1/16/16.
 */
public class Quantity {
    ...
    public static enum Unit {
        tsp(1.0d), tbs(0.3333), cup(0.0208d), oz(0.1666d), pint(0.0104d), quart(0.0052d),
        gallon(0.0013d), pound(0.0123d), ml(4.9289d), liter(0.0049d), mg(5687.5d), kg(0.0057d);
